...
"==============================================================================
nnoremap H         o<ESC>k            " New line below, keep cursor at same column
nnoremap Y         O<ESC>j            " New line above, keep cursor at same column
nnoremap <Leader>3 I#<Esc>             " Prepend '#' at start of line
nnoremap <F3>      o<C-R>=strftime("%A %d of %B %Y %H:%M hrs")<CR><Esc>  " Insert timestamp
...
"==============================================================================
" Exit insert, auto-close pairs and snippets. Aligned comments.
inoremap jj         <Esc>               " Exit insert mode quickly
inoremap zz         <Esc>ZZ             " Save file and exit
inoremap `          ``<left>            " Auto-close backticks
inoremap ¨          ""<left>            " Auto-close diaeresis
inoremap '          ''<left>            " Auto-close single quotes
inoremap "          ""<left>           " Auto-close double quotes
inoremap <          <><left>            " Auto-close angle brackets
inoremap (          ()<left>            " Auto-close parentheses
inoremap [          []<left>            " Auto-close square brackets
inoremap {          {}<left>            " Auto-close braces
inoremap {<CR>      {<CR>}<Esc>O        " Auto-close braces with newline
inoremap {;<CR>     {<CR>};<Esc>O       " Auto-close braces+semicolon
inoremap ///        [//]: # ()<left>      " Markdown comment snippet
inoremap /*         /**/<left><left>     " JS block comment snippet
inoremap <!         <!----><left><left><left> " HTML comment snippet
inoremap <F3>       <C-R>=strftime("%A %d of %B %Y %H:%M hrs ")<CR>  " Inline timestamp
